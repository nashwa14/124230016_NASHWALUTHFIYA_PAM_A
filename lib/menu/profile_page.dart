...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _loadProfileData() async {
    final username = _auth.getSession(); // Ambil username dari session
    if (username != null) {
      // Menggunakan getUserPhoto yang sudah diperbarui di HiveService
  ...
  // ✅ Fungsi Logout melalui AuthController
